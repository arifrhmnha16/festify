        ...
        <div class="grid gap-5 lg:grid-cols-[1fr_320px]">
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <label class="flex items-center gap-3 rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm font-bold">
                    ...
                    <input type="checkbox" name="is_promo" value="1" @checked(old('is_promo')) class="h-4 w-4 rounded border-neutral-300 text-orange-700">
            ...
            <aside class="grid gap-4">
                <div class="rounded-xl border border-dashed border-neutral-300 bg-neutral-50 p-5">
                    ...
                    <p class="mt-2 text-xs text-neutral-500">JPG, PNG, atau WEBP. Rasio wajib 4:1, rekomendasi 8000 x 2000 px. Maksimal 10 MB.</p>
                </div>
