...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .band { position: relative; width: 720pt; height: 144pt; overflow: hidden; border: 1pt solid #111; border-radius: 5pt; page-break-after: avoid; page-break-before: avoid; page-break-inside: avoid; }
        .panel { position: absolute; top: 0; height: 144pt; overflow: hidden; }
        .side { left: 0; width: 40.5pt; background: #050505; color: #fff; text-align: center; }
        .side-orange { left: 679.5pt; background: #d92d00; }
        .vertical { padding-top: 39pt; font-size: 6.3pt; line-height: 7.1pt; font-weight: 900; letter-spacing: 1.4pt; text-transform: uppercase; }
        .poster-cell { left: 40.5pt; width: 126pt; background: #171717; border-right: 0.7pt dashed #ccc; }
        .poster-box { position: absolute; left: 12pt; top: 12pt; width: 102pt; height: 120pt; background: #050505; border-radius: 5pt; text-align: center; overflow: hidden; }
        .poster-box img { width: 100%; height: 100%; object-fit: contain; }
        .info { left: 166.5pt; width: 202.5pt; border-right: 0.7pt dashed #ccc; padding: 20pt 12pt 10pt 12pt; }
        ...
        .mini { position: absolute; left: 12pt; bottom: 8pt; white-space: nowrap; }
        ...
        .qr-cell { left: 369pt; width: 111pt; border-right: 0.7pt dashed #ccc; background: #fafaf9; text-align: center; padding-top: 26pt; }
        ...
        .holder { left: 480pt; width: 199.5pt; padding: 24pt 12pt 10pt 12pt; }
        ...
        .gate { position: absolute; left: 12pt; bottom: 9pt; background: #050505; color: white; border-radius: 5pt; padding: 8pt; width: 162pt; height: 39pt; }
