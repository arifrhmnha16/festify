...
<section class="mx-auto grid min-h-[70vh] max-w-5xl items-center px-4 py-12 md:grid-cols-2">
    <div>
        <p class="mb-3 text-sm font-bold uppercase tracking-widest text-orange-700">Area internal</p>
        <h1 class="text-5xl font-black">Login Admin</h1>
        <p class="mt-4 text-neutral-600">Kelola konser, pembayaran, E-Ticket, gelang, petugas, dan laporan scan.</p>
    </div>
    <form method="post" action="{{ route('admin.login.store') }}" class="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <button class="mt-6 w-full rounded-full bg-neutral-950 px-5 py-3 font-bold text-white">Masuk Admin</button>
    </form>
</section>
@endsection
