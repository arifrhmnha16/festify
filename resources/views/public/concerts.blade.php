...
<section class="mx-auto max-w-7xl px-4 py-12">
    <h1 class="text-5xl font-black">Daftar Konser</h1>
    <form class="mt-8 grid gap-3 rounded-lg border border-neutral-200 bg-white p-4 md:grid-cols-[1fr_1fr_180px_auto]">
    ...
    <div class="mt-8 grid gap-6 md:grid-cols-3">@foreach($concerts as $concert)<x-concert-card :concert="$concert" />@endforeach</div>
    <div class="mt-8">{{ $concerts->links() }}</div>
</section>
@endsection
